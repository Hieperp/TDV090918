...
namespace TotalDAL.Repositories.Productions
{
    ...
    public class FinishedHandoverAPIRepository : GenericAPIRepository, IFinishedHandoverAPIRepository
    {
        ...
        public IEnumerable<FinishedHandoverPendingDetail> GetPendingDetails(int? finishedHandoverID, int? plannedOrderID, int? customerID, string finishedProductDetailIDs, bool? isReadonly)
        {
            this.TotalSmartPortalEntities.Configuration.ProxyCreationEnabled = false;
            IEnumerable<FinishedHandoverPendingDetail> finishedHandoverPendingDetails = base.TotalSmartPortalEntities.GetFinishedHandoverPendingDetails(finishedHandoverID, plannedOrderID, customerID, finishedProductDetailIDs, isReadonly).ToList();
            this.TotalSmartPortalEntities.Configuration.ProxyCreationEnabled = true;
