...
namespace TotalDAL.Helpers.SqlProgrammability.Productions
{
    public class FinishedHandover
    {
        ...
        private void GetFinishedHandoverIndexes()
        {
            ...
            queryString = queryString + "       SELECT      FinishedHandovers.FinishedHandoverID, CAST(FinishedHandovers.EntryDate AS DATE) AS EntryDate, FinishedHandovers.Reference, Locations.Code AS LocationCode, ISNULL(Customers.Name + ',    ' + Customers.BillingAddress, N'Bàn giao phôi định hình') AS CustomerDescription, FinishedHandovers.Description, FinishedHandovers.TotalQuantity " + "\r\n";
