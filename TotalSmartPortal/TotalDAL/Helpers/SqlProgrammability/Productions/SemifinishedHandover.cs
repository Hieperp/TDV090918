...
namespace TotalDAL.Helpers.SqlProgrammability.Productions
{
    public class SemifinishedHandover
    {
        ...
        private void GetSemifinishedHandoverIndexes()
        {
            ...
            queryString = queryString + "       SELECT      SemifinishedHandovers.SemifinishedHandoverID, CAST(SemifinishedHandovers.EntryDate AS DATE) AS EntryDate, SemifinishedHandovers.Reference, Locations.Code AS LocationCode, ISNULL(Customers.Name + ',    ' + Customers.BillingAddress, N'Bàn giao phôi định hình') AS CustomerDescription, Workshifts.EntryDate AS WorkshiftEntryDate, Workshifts.Code AS WorkshiftCode, SemifinishedHandovers.Description, SemifinishedHandovers.TotalQuantity " + "\r\n";
        ...
        private void GetSemifinishedHandoverViewDetails()
        {
            ...
            queryString = queryString + "                   SemifinishedProductDetails.CommodityID, Commodities.Code AS CommodityCode, Commodities.Name AS CommodityName, Commodities.CommodityTypeID, SemifinishedProductDetails.ProductionLineID, ProductionLines.Code AS ProductionLineCode, SemifinishedProductDetails.CrucialWorkerID, Employees.Name AS CrucialWorkerName, " + "\r\n";
            queryString = queryString + "                   SemifinishedHandoverDetails.Quantity, SemifinishedProductDetails.QuantityGainings, SemifinishedHandoverDetails.Remarks" + "\r\n";
            ...
            queryString = queryString + "                   INNER JOIN Employees ON SemifinishedProductDetails.CrucialWorkerID = Employees.EmployeeID " + "\r\n";
