...
namespace TotalDAL.Helpers.SqlProgrammability.Productions
{
    public class SemifinishedHandover
    {
        ...
        private void GetSemifinishedHandoverViewDetails()
        {
            ...
            queryString = queryString + "       SELECT      SemifinishedHandoverDetails.SemifinishedHandoverDetailID, SemifinishedHandoverDetails.SemifinishedHandoverID, SemifinishedProducts.SemifinishedProductID, SemifinishedProducts.EntryDate, SemifinishedProducts.CustomerID, Customers.Code AS CustomerCode, Customers.Name AS CustomerName, " + "\r\n";
        ...
        private string GetPendingBUILDSQLNew(bool isCustomerID, bool isSemifinishedProductIDs)
        {
            ...
            queryString = queryString + "       SELECT      SemifinishedProducts.SemifinishedProductID, SemifinishedProducts.EntryDate, SemifinishedProducts.CustomerID, Customers.Code AS CustomerCode, Customers.Name AS CustomerName, " + "\r\n";
        ...
        private void SemifinishedHandoverSheet()
        {
            ...
            queryString = queryString + "                   FirmOrders.Reference AS FirmOrderReference, FirmOrders.Code AS FirmOrderCode, Customers.Name AS CustomerName, SemifinishedProducts.Reference AS SemifinishedProductReference, SemifinishedLeaders.Name AS SemifinishedLeaderName, FinishedLeaders.Name AS FinishedLeaderName, SemifinishedHandoverDetails.Quantity " + "\r\n";
