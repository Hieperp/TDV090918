...
namespace TotalDAL.Helpers.SqlProgrammability.Productions
{
    public class FinishedProduct
    {
        ...
        private void GetFinishedProductIndexes()
        {
            ...
            queryString = queryString + "       SELECT      FinishedProducts.FinishedProductID, CAST(FinishedProducts.EntryDate AS DATE) AS EntryDate, FinishedProducts.Reference, Locations.Code AS LocationCode, Customers.Code AS CustomerCode, Customers.Name AS CustomerName, FirmOrders.Specs, FinishedProducts.Description, FinishedProducts.TotalQuantity, FinishedProducts.TotalQuantityFailure, FinishedProducts.TotalSwarfs, FinishedProducts.Approved " + "\r\n";
        ...
        private void FinishedProductToggleApproved()
        {
            ...
            queryString = queryString + "                   BEGIN " + "\r\n";
            queryString = queryString + "                       INSERT INTO     FinishedProductPackages (FinishedProductID, EntryDate, LocationID, CustomerID, FirmOrderID, PlannedOrderID, CommodityID, CommodityTypeID, PiecePerPack, Quantity, QuantityFailure, Swarfs, QuantityReceipted, Packages, OddPackages, QuantityWeights, QuantityFailureWeights, Remarks, Approved, HandoverApproved, SemifinishedProductReferences) " + "\r\n";
