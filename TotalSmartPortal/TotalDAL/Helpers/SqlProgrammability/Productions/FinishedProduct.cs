...
namespace TotalDAL.Helpers.SqlProgrammability.Productions
{
    public class FinishedProduct
    {
        ...
        private void FinishedProductToggleApproved()
        {
            ...
            queryString = queryString + "                   BEGIN " + "\r\n";
            queryString = queryString + "                       INSERT INTO     FinishedProductPackages (FinishedProductID, EntryDate, LocationID, CustomerID, FirmOrderID, PlannedOrderID, CommodityID, CommodityTypeID, PiecePerPack, Quantity, QuantityFailure, Swarfs, QuantityReceipted, Packages, OddPackages, QuantityWeights, QuantityFailureWeights, Remarks, Approved, HandoverApproved, Caption) " + "\r\n";
            ...
            queryString = queryString + "                                       FOR XML PATH(''),TYPE).value('(./text())[1]','VARCHAR(MAX)'),1,1,'') AS Caption " + "\r\n";
