...
namespace TotalDAL.Helpers.SqlProgrammability.Productions
{
    public class PlannedOrder
    {
        ...
        private void GetPlannedOrderIndexes()
        {
            ...
            queryString = queryString + "       SELECT      PlannedOrders.PlannedOrderID, CAST(PlannedOrders.EntryDate AS DATE) AS EntryDate, PlannedOrders.Reference, PlannedOrders.Code, Customers.Name AS CustomerName, PlannedOrders.DeliveryDate, PlannedOrders.Specs, Locations.Code AS LocationCode, ISNULL(VoidTypes.Name, CASE PlannedOrders.InActivePartial WHEN 1 THEN N'Hủy một phần đh' ELSE N'' END) AS VoidTypeName, PlannedOrders.Description, PlannedOrders.TotalQuantity, PlannedOrders.Approved, PlannedOrders.InActive, PlannedOrders.InActivePartial " + "\r\n";
        ...
        private void GetPlannedOrderViewDetails()
        {
            ...
            queryString = queryString + "                   PlannedOrderDetails.QuantityRequested, PlannedOrderDetails.QuantityOnhand, PlannedOrderDetails.Quantity, PlannedOrderDetails.InActivePartial, PlannedOrderDetails.InActivePartialDate, PlannedOrderDetails.Remarks " + "\r\n";
