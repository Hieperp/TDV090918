...
namespace TotalDAL.Helpers.SqlProgrammability.Reports
{
    public class InventoryReports
    {
        ...
        private void WarehouseCards()
        {
            ...
            queryString = queryString + "                   SELECT      'WarehouseTransfers' AS ControllerName, WarehouseTransferDetails.WarehouseTransferID AS EntityID, HH TẠI KHO' AS GroupName, CONVERT(VARCHAR, @LocalFromDate, 103) + ' -> ' + CONVERT(VARCHAR, @LocalToDate, 103) AS SubGroupName, WarehouseTransferDetails.EntryDate, GoodsReceiptDetails.CommodityID, GoodsReceiptDetails.Reference, GoodsReceiptDetails.Code AS ReceiptCode, GoodsReceiptDetails.WarehouseID, 'XUAT VCNB: ' + Warehouses.Name AS Description, 0 AS QuantityDebit, WarehouseTransferDetails.Quantity AS QuantityCredit " + "\r\n";
            ...
            queryString = queryString + "                               WarehouseTransfers ON WarehouseTransferDetails.WarehouseTransferID = WarehouseTransfers.WarehouseTransferID INNER JOIN " + "\r\n";
